...
class WindSpeedConverterEnter(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Viteza vântului - calcul Enter & Buton")
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.input_edit.bind("<Return>", self.calculate)
        
        self.result_label = ttk.Label(self, text="Rezultat (km/h):")
        self.calculate_btn = ttk.Button(self, text="Recalculează", command=self.calculate)
